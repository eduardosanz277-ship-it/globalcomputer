                ...
                <div className="min-w-0">
                  ...
                  {href ? (
                    <a
                      ...
                      className={cn(
                        "mt-1.5 block min-w-0 text-sm font-medium leading-relaxed text-foreground transition hover:text-primary sm:text-lg",
                        id === "email" && "break-all",
                    ...
                    <p className="mt-1.5 min-w-0 break-words text-sm font-medium leading-relaxed text-foreground sm:text-lg">
                      {value}
                    </p>
                  )}
                </div>
