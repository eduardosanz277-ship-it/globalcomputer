export const en = {
  ...
  header: {
    ...
    expandSubitems: "Show options for {name}",
    collapseSubitems: "Hide options for {name}",
    itemOne: "item",
    itemMany: "items",
    viewBy: "View by",
    nav: {
  ...
  orderLookup: {
    metaTitle: "Track order | Global Computers USA",
    metaDescription:
  ...
  storefront: {
    ...
    cart: {
      ...
      quoteAddressTitle: "Shipping address",
      quoteAddressDescription:
        "Tell us where to quote shipping. We’ll use this for the order and the WhatsApp message.",
      quoteAddressLoading: "Loading address…",
      quoteAddressRecipientName: "Recipient name",
      quoteAddressRecipientPhone: "Phone",
      quoteAddressRecipientEmail: "Email (optional)",
      quoteAddressLine: "Address",
      quoteAddressLine2: "Apartment, suite, etc. (optional)",
      quoteAddressCity: "City",
      quoteAddressState: "Province / State",
      quoteAddressStatePlaceholderNarrow: "Search province...",
      quoteAddressPostalCode: "ZIP / postal code",
      quoteAddressCountry: "Country",
      quoteAddressRequiredMasculine: "The {label} is required",
      quoteAddressRequiredFeminine: "The {label} is required",
      quoteAddressPostalCodeRequired: "The postal code is required",
      quoteAddressPhoneInvalid: "Enter a valid phone number",
      quoteAddressEmailInvalid: "Enter a valid email",
    ...
    productDetail: {
      ...
      downloadManual: "Download or view manual (PDF)",
      infoTabsAria: "Product information",
      descriptionTitle: "Description",
      expandSection: "Expand {title}",
      collapseSection: "Collapse {title}",
      zoomImageAria: "View enlarged image",
      zoomImageTitle: "{name} — enlarged view",
      prevImageAria: "Previous image",
      nextImageAria: "Next image",
      viewImageAria: "View image {n}",
      skuLabel: "SKU",
      similarTitle: "Similar products",
      similarSubtitle: "Discover other options you might like.",
      accessoriesTitle: "Complete your purchase",
      accessoriesSubtitle: "Compatible accessories for this product.",
      similarPrevAria: "Previous products",
      similarNextAria: "Next products",
      ...
      reviewsAbout: "Reviews of {name}.",
      writeReview: "Write a review",
      writeFirstReview: "Write the first review",
      reviewsEmpty:
        "This product has no reviews yet. Be the first to share your experience.",
      reviewsNoMatch:
        "No reviews match the filters. Adjust the criteria to see more results or",
      reviewsClearAll: "Clear all",
      reviewsSortAria: "Sort reviews by date",
      reviewsRatingAria: "Filter reviews by rating",
      reviewsClearFilters: "Clear filters",
      reviewsPaginationAria: "Product reviews pagination",
      reviewsShowing: "Showing",
      reviewsOf: "of",
      reviewsPrev: "Previous",
      reviewsNext: "Next",
      reviewsNoComment: "No written comment.",
      reviewsSortPrefix: "Sort by:",
      reviewsRatingPrefix: "Rating:",
      sortNewest: "Newest",
      sortOldest: "Oldest",
      sortBest: "Highest rating",
      sortWorst: "Lowest rating",
      ratingAll: "All",
      ratingStars: "{n} stars",
      ratingStarOne: "1 star",
      starsAria: "{n} out of 5 stars",
      reviewPanelTitle: "Write a review",
      reviewPanelDescription:
        "Share your experience with {name}. Your review will help others shop with more confidence.",
      reviewPanelAria: "Product review form",
      reviewCancel: "Cancel",
      reviewSending: "Sending",
      reviewSubmit: "Submit review",
      reviewFormHint: "Your opinion helps other customers decide.",
      reviewFormLoading: "Loading details",
      reviewFormName: "Name",
      reviewFormNamePlaceholder: "Your name or alias",
      reviewFormEmail: "Email (optional)",
      reviewFormEmailPlaceholder: "email@example.com",
      reviewFormRating: "How was this product?",
      reviewFormComment: "Comment",
      reviewFormCommentPlaceholder: "Tell us about your experience with this product.",
      reviewFormSuccess: "Review sent. Thank you for rating this product.",
      reviewFormError: "Could not send the review.",
      reviewFormUnexpected: "Unexpected error.",
      reviewApiInvalidJson: "The request body must be valid JSON.",
      reviewApiInvalidData: "Invalid data for the product review.",
      reviewApiDuplicate:
        "You have already posted a review for this product. You can update it later.",
      reviewApiSaveError: "Could not save the review.",
      reviewNameRequired: "Name is required",
      reviewNameMin: "Name must be at least 2 characters",
      reviewNameMax: "Maximum 120 characters",
      reviewEmailInvalid: "Enter a valid email",
      reviewProductInvalid: "Invalid product",
      reviewRatingRequired: "Rating is required",
      reviewRatingInvalid: "Select a rating",
      reviewRatingRange: "Rating must be between 1 and 5",
      reviewCommentRequired: "Comment is required",
      reviewCommentMax: "Maximum 1200 characters",
      ratingPoor: "Poor",
      ratingFair: "Fair",
      ratingGood: "Good",
      ...
      ratingStarWord: "stars",
      ratingStarWordOne: "star",
    },
    cartSuccess: {
      metaTitle: "Payment received",
      metaDescription: "Thank you for your purchase.",
      heading: "Thank you for your purchase!",
      confirmation: "Your order has been confirmed successfully.",
      emailHint: "We have sent your order details to your email.",
      orderNumberLabel: "Order no.",
      copyOrderNumberAria: "Copy order number",
      copyOrderNumberToast: "Order number copied",
      copyOrderNumberError: "Could not copy the order number",
  ...
  profile: {
    ...
    dialogRecipientTitle: "Recipient",
    close: "Close",
  ...
  admin: {
    ...
    products: {
      ...
      form: {
        ...
        media: {
          ...
          manualHint: "PDF format. Maximum 5 MB.",
          manualInvalidFile: "Invalid file. Select a PDF of up to 5 MB.",
          manualReplace: "Replace",
          manualDelete: "Delete",
          manualView: "View PDF",
          manualPending: "Pending save",
        },
        characteristics: {
      ...
      detail: {
        ...
        expandAccessories: "Expand accessories",
        collapseAccessories: "Collapse accessories",
        accessories: "Accessories",
        noAccessories: "No linked accessories",
        metadata: "Metadata",
    ...
    orders: {
      ...
      table: {
        ...
        items: "Details",
        viewItems: "View details",
        createdAt: "Date",
        createdAtSortIdle: "Sort by date",
