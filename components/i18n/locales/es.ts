export const es = {
  ...
  storefront: {
    ...
    productDetail: {
      ...
      similarSubtitle: "Descubre otras opciones que podrían interesarte.",
      accessoriesTitle: "Completa tu compra",
      accessoriesSubtitle: "Accesorios compatibles con este producto.",
  ...
  admin: {
    ...
    products: {
      ...
      detail: {
        ...
        expandAccessories: "Expandir accesorios",
        collapseAccessories: "Contraer accesorios",
        accessories: "Accesorios",
        noAccessories: "Sin accesorios vinculados",
        metadata: "Metadatos",
